...
public class SkillsController {
    ...
    public SkillsController(SkillsSerivce skillsSerivce,
    ...
    public List<SkillsResponse> create(@PathVariable(value = "id") Long id,
                                       @RequestBody @Valid SkillsRequest skillsRequest) throws JobSearchException {
